@extends('layouts.admin')
		...
		<ul>
            <li>
                ...
                <ul class="sub_menu">
                    ...
                    <li><a href="{{url('admin/article')}}" target="main"><i class="fa fa fa-fw fa-list-ul"></i>文章列表</a></li>
                    <li><a href="" target="main"><i class="fa fa-fw fa-list-ul"></i>管理评论</a></li>
                    <li><a href="{{url('admin/picture/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加图片</a></li>
                    <li><a href="{{url('admin/picture/')}}" target="main"><i class="fa fa-fw fa-image"></i>图片列表</a></li>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub_menu" style="display: block">
					...
					<li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-navicon"></i>导航链接</a></li>
	...
	<div class="bottom_box">
		CopyRight © 2017. Powered By <a href="http://www.myblog.com">http://www.myblog.com</a>.
	</div>
	<!--底部 结束-->
@endsection