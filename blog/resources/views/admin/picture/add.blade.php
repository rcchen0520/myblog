...
<div class="crumb_warp">
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 添加图片
</div>
<!--导航 结束-->
...
<div class="result_wrap">
    <form action="{{url('admin/picture')}}" method="post">
        ...
        <table class="add_tab">
            <tbody>
            <tr>
                <th width="120"><i class="require">*</i>图片分类：</th>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="pic_name">
            ...
            <tr>
                <th>图片描述：</th>
                <td>
                    <textarea name="pic_tips"></textarea>
                </td>
            </tr>
            <tr>
                <th><i class="require"></i>上传图片：</th>
                <td>
                    <input type="text" size="50px" name="pic_url">
            ...
            <tr>
                <th></th>
                <td>
                    <img src="" alt="" id="art_thumb_img" style="max-width: 150px;max-height: 100px;">
                </td>
            </tr>
            <tr>
                <th></th>
