            ...
            <table class="add_tab">
                <tbody>
                        ...
                        <td>
                            <select name="art_cate_id">
                                ...
                                <option value="{{$d->cate_id}}"
                                        @if($d->cate_id==$field['art_cate_id']) selected @endif
                                        >{{$d->_cate_name}}</option>
                                @endforeach
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" size="50px" name="art_thumb" value="{{$field['art_thumb']}}">
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="/{{$field['art_thumb']}}" alt="" id="art_thumb_img" style="max-width: 150px;max-height: 100px;">
                        </td>
                    </tr>
                    <tr>
                        <th>关键词：</th>
